...
class G:
  ...
  TRAIN_FEATURES = train_stack(big_dict = WINDOW_SAMPLING_DICT,
  ...
  TRAIN_LABELS = train_stack(big_dict = WINDOW_SAMPLING_DICT,
                                train_ratio = PERCENT_OF_TRAIN,
                                sensitivity = SAMPLES_PER_SAMPLE,
                                TRAIN_RELAX_PROPORTION = TRAIN_RELAX_PROPORTION,
                                RELAX_PROPORTION = RELAX_PROPORTION,
  ...
  PREDICT_FEATURES = predict_stack(big_dict = WINDOW_SAMPLING_DICT,
                                  train_ratio = PERCENT_OF_TRAIN,
                                  sensitivity = SAMPLES_PER_SAMPLE,
                                  TRAIN_RELAX_PROPORTION = TRAIN_RELAX_PROPORTION,
                                  RELAX_PROPORTION = RELAX_PROPORTION,
  ...
  PREDICT_LABELS = predict_stack(big_dict = WINDOW_SAMPLING_DICT,
                                  train_ratio = PERCENT_OF_TRAIN,
                                  sensitivity = SAMPLES_PER_SAMPLE,
                                  TRAIN_RELAX_PROPORTION = TRAIN_RELAX_PROPORTION,
                                  RELAX_PROPORTION = RELAX_PROPORTION,
  ...
  TRAIN_BATCH_SIZE = 180#int(TOTAL_TRAIN_DATA / 4) #/8
...
print('Traing model...')
history = model.fit(x = G.TRAIN_FEATURES, y = G.TRAIN_LABELS, #batch_size = G.BATCH_SIZE,
                    steps_per_epoch = G.TRAIN_STEPS,
                    shuffle = True,
                    #callbacks = Callbacks,
                    epochs = G.EPOCHS,
