...
def wl_model(project_dataclass):
  ...
  last_layer = copied_model.get_layer('mixed10') #gets the layer from which the InceptionV3 model output should
  ...
  last_output_from_copied_model = last_layer.output #gets the output of the last layer
